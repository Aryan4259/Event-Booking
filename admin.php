...
<div class="left-navigation">
 ...
 <section class="main" id="today">
        <div class="main-top">
                <h1 style="color: #fff; text-decoration:underline; margin-bottom:20px;margin-left:250px;">Ticket  </h1>
            </div>
            <div class="thead">
        <div class="th">
    ...
    ?>
            ...
            <div><?php echo $row['event_name']; ?></div>
            <div><?php echo $row['no_of_tickets']; ?></div>
