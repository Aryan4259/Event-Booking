...
$sql="DELETE FROM `eventlist` WHERE  EventId='$id'";
...
<form action="delete_Event.php" method="post">
	<div id="DebitCard"  class="pay">
		<h3>Delete Event Detail</h3>
		<p>Enter Event Id</p>
        <input type="text" name="id" placeholder="Event Id" class="in">
        <br>
 ...
 <div class="plant">
 <caption>Your Event Details</caption>
 <table border="1">
    <tr>
    <th>id</th>
    <th>Name</th>
